...
class ApprovalProcessModel(models.Model):
    ...
    # allowed_submitter = models.ManyToManyField(IamRoleModel, related_name="approval_process_roles",  help_text="Roles allowed to submit records for this approval process")
