...
from dmsmodule.folder.views.get_folder_request_handler import GetFolderRequestHandler, GetOwnerFolderRequestHandler
...
urlpatterns = [
    ...
    path('get_sfolder/', GetOwnerFolderRequestHandler.as_view()),

    # path('get_folder/', get_folder_data),
