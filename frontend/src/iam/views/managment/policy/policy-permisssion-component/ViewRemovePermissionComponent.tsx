...
import { useGetAllRemoveViewListQuery } from '../../../../features/policiesAPI'
import { FlexBox, Text } from '../../../../components/reusable/StyledComponent'
import { usePolicyContext } from '../context/usePolicyContext'

const ViewRemovePermissionComponent = () => {
    const {data, isSuccess, isError} = useGetAllRemoveViewListQuery()
...
export default ViewRemovePermissionComponent