...
const NewPolicyComponent = () => {
  return (
    <FlexOuterContainer className='mx-4 my-2 h-full'>
        <FlexBox className='flex flex-col pt-3 pb-4'>
            <Text className='text-[20px] font-semibold'>
                Creating New Permission<span className='block text-[12px] font-Poppins font-normal pt-[2px] text-[#333] text-opacity-55'>
