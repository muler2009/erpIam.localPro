...
import { useGetAppLevelPolicicesQuery } from '../../../../features/policiesAPI'
        ...
        <FlexBox className='mx-4 mt-2 h-full flex flex-col justify-center'>   
            {
                ...
                error ? (
                    ...
                    isSuccess && appLevelPolicyData?.length > 0 ? (
...
export default GetAllApplicationLevelPoliciesComponent