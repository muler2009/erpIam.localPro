  ...
  return (
    <div className="flex flex-col space-y-2 text-sm text-[#fff] py-2 px-5">
        ...
        <div className='flex space-x-6 text-[12px]'>
            ...
            <div className='leading-5'>{rowData?.attempt_time}</div>
        </div>
        <div className='flex space-x-6 text-[12px]'>
        ...
        <div className='flex space-x-6 text-[12px]'>
            ...
            <div className='leading-5'>{rowData?.user_agent}</div>
        </div>
    ...
    return (
        <div className="flex flex-col space-y-2 text-sm text-[#fff] py-2 px-5 "> 
            ...
            <div className='flex space-x-2 text-[12px]'>
                ...
                <div className='pl-5 leading-2'>{rowData?.event?.reason || "NOT_FOUND"}</div>
            </div>        
        </div>    
    )
}
